...
const MainComponent = () => {
  return (
    ...
    <img className='w-[500px] mx-auto my-4' src={gamingmain} alt='controller' />
    <div className='flex flex-col justify-center'>
        ...
        <button className='bg-[#191A19] w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3 text-[#4E9F3D]'>Get Started</button>
    </div>
    </div>
    </div>
  )
